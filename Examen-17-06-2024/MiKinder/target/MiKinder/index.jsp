...
<div class="container">
    ...
    <form id="registrationForm" class="col-12">
        <div class="section col-12">
            ...
            <label for="childPassword">Contraseña *</label>
            <input type="password" id="childPassword" name="childPassword" required>
            <label for="childPasswordConfirm">Confirmar Contraseña *</label>
            <input type="password" id="childPasswordConfirm" name="childPasswordConfirm" required>
        </div>
